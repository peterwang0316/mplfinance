...
apds = [mpf.make_addplot(exp12,color='lime', legend='exp12'),
        mpf.make_addplot(exp26,color='c', legend='exp26'),
        mpf.make_addplot(histogram,type='bar',width=0.7,panel=1,
                         color='dimgray',alpha=1,secondary_y=False),
        mpf.make_addplot(macd,panel=1,color='fuchsia',secondary_y=True, legend='macd'),
        mpf.make_addplot(signal,panel=1,color='b',secondary_y=True, legend='signal'),
       ]
...
#     signal    = macd.ewm(span=9, adjust=False).mean()
#     histogram = macd - signal
#     apds = [mpf.make_addplot(exp12,color='lime',ax=ax_emav, title='exp12'),
#             mpf.make_addplot(exp26,color='c',ax=ax_emav, title='exp26'),
